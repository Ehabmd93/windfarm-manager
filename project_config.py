...
PROJECT_TYPE_PROFILES = {
    'Wind Farm': {
        ...
        'default_features': ['map', 'proof_rolling', 'geo_testing', 'itp', 'foundation',
    ...
    'Solar Farm': {
        ...
        'default_features': ['map', 'itp', 'progress_tracker', 'documents'],
    ...
    'Civil Construction': {
        ...
        'default_features': ['map', 'proof_rolling', 'geo_testing', 'itp', 'progress_tracker', 'documents'],
    ...
    'Mining': {
        ...
        'default_features': ['map', 'itp', 'documents', 'progress_tracker'],
